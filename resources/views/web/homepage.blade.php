<x-layout>
    ...
    {{-- Jika $categories belum didefinisikan, inisialisasi dengan collection kosong --}}
    @if(!isset($categories))
        @php $categories = collect(); @endphp
    @endif

    {{-- Tambah CSS Bootstrap --}}
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">

    {{-- Tambahan CSS responsif untuk ukuran layar kecil --}}
    <style>
    ...
    {{-- SECTION: Carousel Gambar --}}
    <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-indicators">
            {{-- Tombol indikator slide --}}
    ...
    <div class="container py-3 px-3 px-md-0">
        ...
        {{-- Tampilkan semua kategori dalam grid --}}
